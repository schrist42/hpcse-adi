...
filename1 = 'hybrid_data_8_strong_scaling_mpi_512.dat'
filename2 = 'hybrid_data_8_strong_scaling_mpi_1024.dat'
filename3 = 'hybrid_data_8_strong_scaling_mpi_2048.dat'
filename4 = 'hybrid_data_8_strong_scaling_mpi_4096.dat'
...
if len(data1[0]) > 4: # with error
    ax1.errorbar(data1[:,0], serial1/data1[:,2], yerr=data1[:,4], label='N = 512', color='r')
    ax1.errorbar(data2[:,0], serial2/data2[:,2], yerr=data2[:,4], label='N = 1024', color='b')
    ax1.errorbar(data3[:,0], serial3/data3[:,2], yerr=data3[:,4], label='N = 2048', color='g')
    ax1.errorbar(data4[:,0], serial4/data4[:,2], yerr=data4[:,4], label='N = 4096', color='y')
else: # without error
...
ax1.set_title('Hybrid version strong scaling \n (with 8 OpenMP threads per MPI process')
plt.legend()
...
plt.savefig('hybrid_strong_scaling.pdf')
plt.show()
