...
# load data
filename1 = 'mpi_data_strong_scaling_512.dat'
filename2 = 'mpi_data_strong_scaling_1024.dat'
filename3 = 'mpi_data_strong_scaling_2048.dat'
filename4 = 'mpi_data_strong_scaling_4096.dat'
...
ax1.set_title('MPI version strong scaling \n (transposing using different data types)')
...
plt.savefig('mpi_data_strong_scaling.pdf')
plt.show()
